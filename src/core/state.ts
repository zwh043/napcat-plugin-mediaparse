...
function sanitizeConfig(raw: unknown): PluginConfig {
    ...
    // 多源解析配置清洗
    if (typeof raw.apizeroApiKey === 'string') out.apizeroApiKey = raw.apizeroApiKey;
    if (typeof raw.enableApizero === 'boolean') out.enableApizero = raw.enableApizero;
    if (typeof raw.enableXinyew === 'boolean') out.enableXinyew = raw.enableXinyew;
    if (typeof raw.enableXhus === 'boolean') out.enableXhus = raw.enableXhus;
